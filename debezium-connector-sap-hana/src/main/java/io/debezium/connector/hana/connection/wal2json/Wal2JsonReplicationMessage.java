...
package io.debezium.connector.hana.connection.wal2json;
...
import io.debezium.connector.hana.connection.ReplicationMessageColumnValueResolver;
...
class Wal2JsonReplicationMessage implements ReplicationMessage {
     ...
     * {@link HanaValueConverter#converter(Column, Field)} instance to match whatever the Connect schema type expects.
     *
